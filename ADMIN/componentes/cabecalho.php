  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      <a href="../index.php" class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
        <img src="ImagensProjeto/xbox (1).png" width="60" height="60" class="d-inline-block align-top" alt="">
      </a>
      ...
      <div class="dropdown text-end">
        <a href="#" class="d-block text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown"
          aria-expanded="false">
          <img src="ImagensProjeto/user.png" alt="mdo" width="62" height="62" class="rounded-circle">
        </a>
